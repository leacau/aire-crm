...
import { createProspect, createClientActivity, getProspects } from '@/lib/firebase-service';
import type { Prospect, ClientActivity, User } from '@/lib/types';
import { z } from 'zod';
...
const createProspectTool = ai.defineTool(
  {
    name: 'createProspect',
    description: 'Creates a new prospect in the CRM.',
...
const commanderPrompt = ai.definePrompt({
    ...
    tools: [createProspectTool, scheduleTaskTool],
