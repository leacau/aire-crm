...
import { signInWithEmailAndPassword, GoogleAuthProvider, getRedirectResult, signInWithPopup } from 'firebase/auth';
...
export default function LoginPage() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      // The onAuthStateChanged listener in useAuth will detect the user and redirect.
    } catch (error: any) {
  ...
  if (authLoading || isProcessingGoogle) {
    return (
    ...
    <div className="flex min-h-screen items-center justify-center bg-background">
      <Card className="w-full max-w-sm">
        ...
        <CardContent className="grid gap-4">
            <Button variant="outline" onClick={handleGoogleSignIn} disabled={loading || isProcessingGoogle}>
        ...
        <form onSubmit={handleLogin}>
          ...
          <CardFooter className="flex flex-col">
            <Button type="submit" className="w-full" disabled={loading || isProcessingGoogle}>
