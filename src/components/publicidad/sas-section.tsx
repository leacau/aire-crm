            ...
            <div className="flex justify-end mt-4">
                <div className="w-full max-w-2xl bg-slate-50 p-4 rounded-lg border grid grid-cols-2 gap-x-8 gap-y-2 shadow-sm">
                    ...
                    <div className="flex justify-between items-center text-sm">
                        ...
                        <div className="w-32">
                            <Input 
                                ...
                                onChange={(e) => {
                                    const valVendido = parseFloat(e.target.value);
                                    if (!isNaN(valVendido)) {
                                        form.setValue("adjustmentSas", Math.max(0, subtotal - valVendido), { shouldValidate: true });
                                    }
                                }}
                            />
                        </div>
                    ...
                    <div className="flex justify-between items-center text-sm text-muted-foreground">
                        <span>IVA 5% (Sobre el Valor Vendido):</span>
                    ...
                    <div className="flex justify-between items-center text-sm col-span-2 border-t pt-2 mt-2">
                        <span className="font-bold">Total a Facturar (Mensual):</span>
